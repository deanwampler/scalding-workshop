/*
 ...
 Additional notes: Copyright 2013-2016 Concurrent Thought, Inc.
...
/**
 * This example from the Summingbird distribution implements Word Count, like
 * our WordCount2 exercise. (It also strips non alphanumeric characters.)
 * This example can be found in the Summingbird distribution here:
 *   summingbird-example/src/main/scala/com/twitter/summingbird/example/ExampleJob.scala
 * For more on Summingbird, see this announcement blog post:
